                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-700/50">
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 bg-primary-500/10 text-primary-400 rounded-full text-sm font-medium border border-primary-500/20">Backend Java</span>
                                    <span className="px-3 py-1 bg-purple-500/10 text-purple-400 rounded-full text-sm font-medium border border-purple-500/20">Fullstack Next.js/ReactJS</span>
                                    <span className="px-3 py-1 bg-blue-500/10 text-blue-400 rounded-full text-sm font-medium border border-blue-500/20">Kafka & Redis</span>
                                </div>
                            </div>
                        </div>
                    </div>
